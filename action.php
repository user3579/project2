  ...
  if(isset($_POST["get_cart_product"]) || isset($_POST["cart_checkout"])){
    ...
    if($count > 0){
      ...
      <form class="" action="https://www.sandbox.paypal.com/cgi-bin.webscr" method="post">
        ...
        echo '<input style="float:right;margin-right:30px;" type="image" name="submit" src="http://www.paypalobjects.com/webstatic/en_US/i/btn/png/blue-rect-paypalcheckout-60px.png" alt="PayPal Checkout">
      </form>
      ';
